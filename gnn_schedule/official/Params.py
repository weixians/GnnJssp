...
parser.add_argument("--input_dim", type=int, default=8, help="number of dimension of raw node features")
...
parser.add_argument("--output", type=str, default="output/gnn_schedule", help="root path of output dir")
